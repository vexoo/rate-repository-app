...
import { abbreviateNumber } from '../../components/ItemDetails'
...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent(
        abbreviateNumber(repositories.edges[0].node.forksCount)
      )
      expect(secondRepositoryItem).toHaveTextContent(
        abbreviateNumber(repositories.edges[1].node.forksCount)
      )
    })
  })
})
